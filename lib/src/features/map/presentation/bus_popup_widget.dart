...
import '../../passenger/booking_screen.dart'; // 🔥 ADDED: Import BookingScreen
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                const Icon(Icons.timer, color: Color(0xFF38BDF8)),
          ...
          // 🔥 FIX: Book Seat Button now uses BookingScreen constructor
          SizedBox(
            width: double.infinity,
